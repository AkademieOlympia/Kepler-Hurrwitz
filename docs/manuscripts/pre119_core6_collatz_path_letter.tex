...
A follow-up formalization (D3.4; German article
\texttt{docs/manuscripts/pre119\_core6\_residualdynamik.de.tex}) proves the
static split
\[
  \Residual
  \;=\;
...
starts that remain forever expanding at every block boundary.
