...
**Warum strukturell:** Für \(p>3\) und alle vier Komponenten prim gilt

\[
\{p,\, p+2,\, p+6,\, p+8\} \bmod 12 = \{1,5,7,11\},
\]

also je ein EABC-Kanal im Produkt — unabhängig vom konkreten Witness.
