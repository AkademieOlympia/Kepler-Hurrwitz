...
| `E-061` | Non-Euclidean Rescue Witnesses (bounded DH-QPID search) | `[B]` | `-` | `src/kepler_hurwitz/dhqpid_prototype.py`, `examples/run_dhqpid_prototype.py`, `docs/theory/dhqpid_prototype_report.md`, `docs/theory/dhqpid_prototype_summary.csv` | `E-053`, `E-064` | `E-062` | Cardoso-Machiavelo `H_{1,7}`, `H_{7,13}`; EUC vs DH rescue classification in bounded window | bounded search; **nicht behauptet:** kein EABC-Claim | numerischer Prototyp | `experimental` | `2026-07-04` |
